...
El servicio `influxdb-service` consulta cada 5 segundos:
...
| `services/influxdb-service/src/generator/db.py` | Query que filtra solo dispositivos asignados y activos |
| `services/influxdb-service/src/generator/influx.py` | Escribe datos a InfluxDB con metadatos completos |
| `services/influxdb-service/src/generator/worker.py` | Loop cada 5 segundos generando datos |
...
```bash
cd /root/HeartGuard/services/influxdb-service
pkill -f "flask.*generator"
export PYTHONPATH=/root/HeartGuard/services/influxdb-service/src
