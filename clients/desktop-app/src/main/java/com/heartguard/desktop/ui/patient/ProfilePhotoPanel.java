...
/**
 * Panel para mostrar y gestionar la foto de perfil del paciente
...
public class ProfilePhotoPanel extends JPanel {
    ...
    public ProfilePhotoPanel(ApiClient apiClient, String accessToken, String patientId) {
    ...
    private void handleUploadPhoto() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            apiClient.uploadPatientPhotoAsync(accessToken, patientId, selectedFile, isUpdate)
    ...
    private void handleDeletePhoto() {
        ...
        apiClient.deletePatientPhotoAsync(accessToken, patientId)
                .thenAccept(response -> SwingUtilities.invokeLater(() -> {
                    progressDialog.dispose();
